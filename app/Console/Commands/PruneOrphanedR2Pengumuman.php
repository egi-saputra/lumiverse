...
class PruneOrphanedR2Pengumuman extends Command
{
    protected $signature = 'r2:prune-orphaned-pengumuman
    ...
    protected $description = 'Hapus file di R2 folder "pengumuman/" (shared: semua tenant Lumiverse + smknusantara) yang tidak dirujuk oleh row manapun. Default dry-run.';
    ...
    public function handle(): int
    {
        ...
        $this->line('Mengumpulkan file_path valid dari smknusantara...');
        try {
        ...
        $filesOnDisk = Storage::disk('r2')->allFiles('pengumuman');
        ...
        foreach ($filesOnDisk as $path) {
            ...
            Log::channel('single')->info('r2-prune-orphaned-pengumuman', [
                'path'      => $path,
