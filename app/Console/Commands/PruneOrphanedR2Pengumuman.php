...
class PruneOrphanedR2Pengumuman extends Command
{
    ...
    protected $description = 'Hapus file di R2 folder "pengumuman/" (shared, bukan per-tenant) yang tidak dirujuk oleh row Pengumuman manapun di SEMUA tenant. Default dry-run.';
