...
// About — subdomain khusus halaman about
Route::domain('about.localhost')->middleware('web')->group(function () {
    Route::get('/', function () {
        return Inertia::render('Home/About', [
            'laravelVersion' => Application::VERSION,
            'phpVersion' => PHP_VERSION,
        ]);
    })->name('home.about.local');
});

Route::domain('about.lumiverse.co.id')->middleware('web')->group(function () {
    Route::get('/', function () {
        return Inertia::render('Home/About', [
            'laravelVersion' => Application::VERSION,
            'phpVersion' => PHP_VERSION,
...
// About — subdomain khusus halaman Artikel
Route::domain('article.localhost')->middleware('web')->group(function () {
    Route::get('/', function () {
        return Inertia::render('Home/Article', [
            'laravelVersion' => Application::VERSION,
            'phpVersion' => PHP_VERSION,
        ]);
    })->name('home.article.local');
});

Route::domain('article.lumiverse.co.id')->middleware('web')->group(function () {
    Route::get('/', function () {
        return Inertia::render('Home/Article', [
            'laravelVersion' => Application::VERSION,
            'phpVersion' => PHP_VERSION,
