...
import { ensureDeviceRegistered } from "@/Utils/device";
import {
    Bars3Icon,
    Squares2X2Icon,
    GiftIcon,
...
function logout() {
    logoutForm.post(route('partner.logout'))
}
    ...
    <div class="app-shell">
        ...
        <aside class="sidebar no-scrollbar" :class="{ 'sidebar-open': sidebarOpen }">
            <div class="sidebar-logo font-poppins">
                <span>Lumiverse <span class="text-cyan">Partnership</span></span>
            </div>

            <nav class="sidebar-nav">
                <Link :href="route('partner.dashboard')" class="nav-item"
                    :class="{ 'nav-item-active': isActive('/dashboard') }" prefetch @click="sidebarOpen = false">
                    <Squares2X2Icon class="nav-icon" />
                    Dashboard
                </Link>

                <Link :href="route('partner.referral.index')" class="nav-item"
                    :class="{ 'nav-item-active': isActive('/referral') }" prefetch @click="sidebarOpen = false">
                    <GiftIcon class="nav-icon" />
                    Referral & Reward
                </Link>

                <Link :href="route('partner.bank-accounts.index')" class="nav-item"
                    :class="{ 'nav-item-active': currentPath.startsWith('/bank-accounts') }" prefetch
