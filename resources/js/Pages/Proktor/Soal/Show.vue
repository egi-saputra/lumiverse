...
async function exportSoal() {
    ...
    try {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Export Gagal',
            text: 'Gagal mengekspor soal. Silakan coba lagi.',
        ...
        <div class="mb-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            ...
            <div class="flex gap-2 w-full sm:w-auto">
                ...
                <button @click="exportSoal" :disabled="isExporting || !soal.bank_soal?.length" class="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5
                    ...
                    <span class="sm:inline-flex hidden">Download</span>
                </button>
                ...
                <button @click="confirmDeleteAll" :disabled="isDeletingAll || !soal.bank_soal?.length" class="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5
                    ...
                    <span class="sm:inline-flex hidden">Hapus Semua</span>
                </button>
            </div>
        </div>
            ...
            <div v-for="(item, index) in soal.bank_soal" :key="item.id" class="group rounded-2xl border border-gray-200 dark:border-slate-800
                ...
                <div class="p-4 space-y-3">
                    ...
                    <div v-if="item.link_lampiran_url">
                        <img :src="item.link_lampiran_url" alt="Lampiran soal"
