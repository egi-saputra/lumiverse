...
<template>
    ...
    <Head>
        <title>Articles | Lumiverse School</title>
        ...
        <meta head-key="og:site_name" property="og:site_name" content="Articles | Lumiverse School" />
        <meta head-key="og:url" property="og:url" content="https://article.lumiverse.co.id/" />
        <meta head-key="og:title" property="og:title" content="Articles | Lumiverse School" />
        ...
        <meta head-key="og:image" property="og:image" content="https://article.lumiverse.co.id/og-image-article.jpg" />
        <meta head-key="og:locale" property="og:locale" content="id_ID" />
        <meta head-key="twitter:card" name="twitter:card" content="summary_large_image" />
        <meta head-key="twitter:title" name="twitter:title" content="Lumiverse — Sistem LMS Sekolah Berbasis Cloud" />
        ...
        <meta head-key="twitter:image" name="twitter:image"
            content="https://article.lumiverse.co.id/og-image-article.jpg" />
        <link head-key="canonical" rel="canonical" href="https://article.lumiverse.co.id/" />
    </Head>
    <AboutSection />
    <ValuesSection />
    <LegalitasSection />
