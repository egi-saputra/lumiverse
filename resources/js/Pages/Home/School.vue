...
<template>
    ...
    <Head>
        ...
        <meta head-key="og:title" property="og:title" content="Lumiverse School" />
        ...
        <meta head-key="og:image" property="og:image" content="https://lumiverse.co.id/og-image-lms.jpg" />
