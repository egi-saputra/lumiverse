...
<template>
    ...
    <OwnerLayout>
        <template #header>
            <h1 class="topbar-title">Tambah Pengguna</h1>
        </template>
        ...
        <div
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Konfirmasi
                        Password</label>
