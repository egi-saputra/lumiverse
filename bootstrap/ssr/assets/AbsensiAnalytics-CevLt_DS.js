import { ref, computed, watch, nextTick, onMounted, onBeforeUnmount, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, withDirectives, vModelText, renderList, vModelSelect, createCommentVNode, createTextVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderStyle } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Analytics Absensi" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="min-h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100" data-v-e4c756a6${_scopeId}><header data-v-e4c756a6${_scopeId}><div class="mx-auto py-4 px-2 flex items-center justify-between gap-4" data-v-e4c756a6${_scopeId}><div class="flex items-center gap-3" data-v-e4c756a6${_scopeId}><div class="w-9 h-9 rounded-xl bg-blue-500/20 text-blue-400 flex items-center justify-center text-lg flex-shrink-0" data-v-e4c756a6${_scopeId}> 📊 </div><div data-v-e4c756a6${_scopeId}><div class="text-sm font-bold dark:text-gray-200 text-gray-700 leading-tight" data-v-e4c756a6${_scopeId}>Attendance Analytics</div><div class="text-xs text-slate-400 mt-0.5" data-v-e4c756a6${_scopeId}>${ssrInterpolate(__props.guru.nama_lengkap)}</div></div></div></div></header><main class="mx-auto space-y-5 pb-10" data-v-e4c756a6${_scopeId}>`);
            if (!__props.kelas) {
              _push2(`<!--[--><div class="text-center py-4" data-v-e4c756a6${_scopeId}><span class="inline-block px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-300 text-[11px] font-bold uppercase tracking-widest mb-3" data-v-e4c756a6${_scopeId}> Langkah 1 </span><h2 class="text-2xl font-extrabold text-slate-800 dark:text-white" data-v-e4c756a6${_scopeId}>Pilih kelas untuk dianalisis </h2><p class="mt-1.5 text-sm text-slate-500 dark:text-slate-400" data-v-e4c756a6${_scopeId}>Lihat insight kehadiran, tren, dan siswa yang perlu perhatian.</p></div><div class="max-w-md mx-auto mb-10" data-v-e4c756a6${_scopeId}><div class="flex items-center gap-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2 focus-within:border-blue-500 dark:focus-within:border-blue-500 transition-colors" data-v-e4c756a6${_scopeId}><span class="text-slate-400 text-sm" data-v-e4c756a6${_scopeId}>🔍</span><input${ssrRenderAttr("value", kelasSearch.value)} type="search" placeholder="Cari kelas atau wali kelas…" class="flex-1 bg-transparent outline-none text-sm placeholder-slate-400 dark:placeholder-slate-500 text-slate-800 dark:text-white" data-v-e4c756a6${_scopeId}></div></div>`);
              if (kelasFiltered.value.length) {
                _push2(`<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3" data-v-e4c756a6${_scopeId}><!--[-->`);
                ssrRenderList(kelasFiltered.value, (k) => {
                  _push2(`<button class="group flex items-center gap-3 bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-2xl p-4 text-left hover:border-blue-400 dark:hover:border-blue-500 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-200" data-v-e4c756a6${_scopeId}><div class="w-11 h-11 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center text-xl flex-shrink-0" data-v-e4c756a6${_scopeId}> 🏫</div><div class="flex-1 min-w-0" data-v-e4c756a6${_scopeId}><div class="font-bold text-slate-800 dark:text-white text-sm" data-v-e4c756a6${_scopeId}>${ssrInterpolate(k.kelas)}</div><div class="mt-1 flex flex-wrap gap-x-3 gap-y-0.5 text-xs text-slate-500 dark:text-slate-400" data-v-e4c756a6${_scopeId}><span data-v-e4c756a6${_scopeId}>👤 ${ssrInterpolate(k.guru_nama)}</span><span data-v-e4c756a6${_scopeId}>🎓 ${ssrInterpolate(k.jumlah_siswa)} siswa</span></div></div><span class="text-slate-300 dark:text-slate-600 group-hover:text-blue-500 group-hover:translate-x-0.5 transition-all text-sm" data-v-e4c756a6${_scopeId}>›</span></button>`);
                });
                _push2(`<!--]--></div>`);
              } else {
                _push2(`<div class="text-center py-16 text-slate-400 dark:text-slate-500" data-v-e4c756a6${_scopeId}><div class="text-4xl mb-3" data-v-e4c756a6${_scopeId}>😶</div><p class="text-sm" data-v-e4c756a6${_scopeId}>Tidak ada kelas yang cocok</p></div>`);
              }
              _push2(`<!--]-->`);
            } else {
              _push2(`<!--[--><div class="flex items-center justify-between gap-3 flex-wrap bg-white dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl px-4 py-3" data-v-e4c756a6${_scopeId}><div class="flex items-center gap-3" data-v-e4c756a6${_scopeId}><div class="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center text-lg flex-shrink-0" data-v-e4c756a6${_scopeId}> 🏫</div><div data-v-e4c756a6${_scopeId}><div class="font-bold text-slate-800 dark:text-white text-sm" data-v-e4c756a6${_scopeId}>${ssrInterpolate(__props.kelas.kelas)}</div><div class="text-xs text-slate-500 dark:text-slate-400 mt-0.5" data-v-e4c756a6${_scopeId}>Wali Kelas: ${ssrInterpolate(__props.kelas.guru_nama)}</div></div></div><button class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-600 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:border-blue-400 dark:hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-all" data-v-e4c756a6${_scopeId}> 🔄 Ganti Kelas </button></div><div class="bg-white dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 space-y-4" data-v-e4c756a6${_scopeId}><p class="text-[11px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500 flex items-center gap-1.5" data-v-e4c756a6${_scopeId}> 🔽 Filter Periode </p><div class="flex gap-1 bg-slate-100 dark:bg-slate-900/50 rounded-xl p-1 w-fit" data-v-e4c756a6${_scopeId}><button class="${ssrRenderClass(["flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold transition-all", filterMode.value === "bulan" ? "bg-blue-600 text-white shadow-sm" : "text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white"])}" data-v-e4c756a6${_scopeId}>📆 Per Bulan</button><button class="${ssrRenderClass(["flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold transition-all", filterMode.value === "rentang" ? "bg-blue-600 text-white shadow-sm" : "text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white"])}" data-v-e4c756a6${_scopeId}>📅 Rentang Tanggal</button></div><div class="flex flex-wrap items-end gap-3" data-v-e4c756a6${_scopeId}>`);
              if (filterMode.value === "bulan") {
                _push2(`<!--[--><div class="flex flex-col gap-1" data-v-e4c756a6${_scopeId}><label class="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500" data-v-e4c756a6${_scopeId}>Bulan</label><select class="px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-900/50 text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/40 min-w-[150px] transition" data-v-e4c756a6${_scopeId}><!--[-->`);
                ssrRenderList(BULAN_NAMES, (nama, idx) => {
                  _push2(`<option${ssrRenderAttr("value", idx + 1)} data-v-e4c756a6${ssrIncludeBooleanAttr(Array.isArray(selectedBulan.value) ? ssrLooseContain(selectedBulan.value, idx + 1) : ssrLooseEqual(selectedBulan.value, idx + 1)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(nama)}</option>`);
                });
                _push2(`<!--]--></select></div><div class="flex flex-col gap-1" data-v-e4c756a6${_scopeId}><label class="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500" data-v-e4c756a6${_scopeId}>Tahun</label><select class="px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-900/50 text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/40 min-w-[110px] transition" data-v-e4c756a6${_scopeId}><!--[-->`);
                ssrRenderList(tahunOptions.value, (y) => {
                  _push2(`<option${ssrRenderAttr("value", y)} data-v-e4c756a6${ssrIncludeBooleanAttr(Array.isArray(selectedTahun.value) ? ssrLooseContain(selectedTahun.value, y) : ssrLooseEqual(selectedTahun.value, y)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(y)}</option>`);
                });
                _push2(`<!--]--></select></div><!--]-->`);
              } else {
                _push2(`<!--[--><div class="flex flex-col gap-1" data-v-e4c756a6${_scopeId}><label class="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500" data-v-e4c756a6${_scopeId}>Dari Tanggal</label><div class="relative" data-v-e4c756a6${_scopeId}><input type="date"${ssrRenderAttr("value", tanggalMulai.value)}${ssrRenderAttr("max", tanggalSampai.value || unref(todayStr))} class="date-input w-full pr-10 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-900/50 text-sm text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/40" data-v-e4c756a6${_scopeId}>`);
                ...
                _push2(`</div></div><div class="flex flex-col gap-1" data-v-e4c756a6${_scopeId}><label class="text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500" data-v-e4c756a6${_scopeId}>Sampai Tanggal</label><div class="relative" data-v-e4c756a6${_scopeId}><input type="date"${ssrRenderAttr("value", tanggalSampai.value)}${ssrRenderAttr("min", tanggalMulai.value || void 0)}${ssrRenderAttr("max", unref(todayStr))} class="date-input w-full pr-10 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-900/50 text-sm text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/40" data-v-e4c756a6${_scopeId}>`);
                _push2(ssrRenderComponent(unref(CalendarDaysIcon), { class: "absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 dark:text-slate-500 pointer-events-none" }, null, _parent2, _scopeId));
                _push2(`</div></div><!--]-->`);
              }
              if (filterError.value) {
                _push2(`<p class="text-xs text-rose-500 flex items-center gap-1 pb-1.5" data-v-e4c756a6${_scopeId}>⚠️ ${ssrInterpolate(filterError.value)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<button${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} class="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold disabled:opacity-50 disabled:cursor-not-allowed transition-colors" data-v-e4c756a6${_scopeId}>`);
              if (loading.value) {
                _push2(`<svg class="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24" data-v-e4c756a6${_scopeId}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-e4c756a6${_scopeId}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z" data-v-e4c756a6${_scopeId}></path></svg>`);
              } else {
                _push2(`<span data-v-e4c756a6${_scopeId}>🔍</span>`);
              }
              _push2(` ${ssrInterpolate(loading.value ? "Memuat…" : "Tampilkan")}</button></div></div>`);
              if (!__props.dataLoaded && !hasData.value) {
                _push2(`<div class="bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-2xl px-6 py-16 text-center" data-v-e4c756a6${_scopeId}><div class="text-5xl mb-4" data-v-e4c756a6${_scopeId}>📊</div><p class="font-semibold text-slate-700 dark:text-slate-200" data-v-e4c756a6${_scopeId}>Belum ada data ditampilkan</p><p class="mt-1.5 text-sm text-slate-400 dark:text-slate-500 max-w-xs mx-auto" data-v-e4c756a6${_scopeId}> Pilih periode, lalu klik <strong data-v-e4c756a6${_scopeId}>Tampilkan</strong>. </p></div>`);
              } else if (__props.dataLoaded && !hasData.value) {
                _push2(`<div class="bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-2xl px-6 py-16 text-center" data-v-e4c756a6${_scopeId}><div class="text-5xl mb-4" data-v-e4c756a6${_scopeId}>📭</div><p class="font-semibold text-slate-700 dark:text-slate-200" data-v-e4c756a6${_scopeId}>Belum ada data absensi</p><p class="mt-1.5 text-sm text-slate-400 dark:text-slate-500 max-w-xs mx-auto" data-v-e4c756a6${_scopeId}> Pilih periode lain atau pastikan absensi sudah diinput. </p></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (hasData.value) {
                _push2(`<!--[--><div class="flex items-center flex-wrap gap-3" data-v-e4c756a6${_scopeId}><span class="inline-flex items-center gap-2 bg-slate-900 dark:bg-slate-950 text-sky-300 px-4 py-1.5 rounded-full text-xs font-bold" data-v-e4c756a6${_scopeId}> 📅 ${ssrInterpolate(__props.label)}</span><span class="text-xs text-slate-500 dark:text-slate-400" data-v-e4c756a6${_scopeId}>${ssrInterpolate(rekapKelas.value?.hari_efektif)} hari efektif · ${ssrInterpolate(rekapKelas.value?.total_siswa)} siswa </span></div>`);
                if (bottomSiswa.value.length) {
                  _push2(`<div class="flex items-center gap-3 px-4 py-3 rounded-xl bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800" data-v-e4c756a6${_scopeId}><span class="text-rose-500 text-xl flex-shrink-0" data-v-e4c756a6${_scopeId}>⚠️</span><p class="text-sm text-rose-700 dark:text-rose-300" data-v-e4c756a6${_scopeId}><strong data-v-e4c756a6${_scopeId}>${ssrInterpolate(bottomSiswa.value.length)} siswa</strong> memiliki tingkat kehadiran di bawah ${ssrInterpolate(threshold.value)}%. Segera tindaklanjuti! </p></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<div class="grid grid-cols-1 lg:grid-cols-2 gap-4" data-v-e4c756a6${_scopeId}><div class="bg-white dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden" data-v-e4c756a6${_scopeId}><div class="flex items-center justify-between px-5 py-3 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/30" data-v-e4c756a6${_scopeId}><div class="flex items-center gap-2" data-v-e4c756a6${_scopeId}><span class="text-base" data-v-e4c756a6${_scopeId}>🏆</span><span class="text-[11px] font-bold uppercase tracking-widest text-slate-600 dark:text-slate-400" data-v-e4c756a6${_scopeId}>Kehadiran Tertinggi</span></div><span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300" data-v-e4c756a6${_scopeId}> Top ${ssrInterpolate(topSiswa.value.length)}</span></div><div data-v-e4c756a6${_scopeId}><!--[-->`);
                ssrRenderList(topSiswa.value, (s, idx) => {
                  _push2(`<div class="flex items-center gap-3 px-5 py-3 border-b border-slate-100 dark:border-slate-700/50 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors" data-v-e4c756a6${_scopeId}><span class="text-xs text-slate-400 dark:text-slate-500 font-mono w-4 text-right flex-shrink-0" data-v-e4c756a6${_scopeId}>${ssrInterpolate(idx + 1)}</span><div class="w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300 flex items-center justify-center text-xs font-bold flex-shrink-0" data-v-e4c756a6${_scopeId}>${ssrInterpolate(initials(s.nama_lengkap))}</div><div class="flex-1 min-w-0" data-v-e4c756a6${_scopeId}><div class="text-sm font-semibold text-slate-800 dark:text-white truncate" data-v-e4c756a6${_scopeId}>${ssrInterpolate(s.nama_lengkap)}</div><div class="text-xs text-slate-400 dark:text-slate-500 font-mono" data-v-e4c756a6${_scopeId}>${ssrInterpolate(s.nis)}</div></div><div class="w-20 flex-shrink-0" data-v-e4c756a6${_scopeId}><div class="h-1.5 rounded-full bg-slate-100 dark:bg-slate-700 overflow-hidden mb-1" data-v-e4c756a6${_scopeId}><div class="h-full rounded-full transition-all" style="${ssrRenderStyle({ width: (s.pct_kehadiran ?? 0) + "%", background: pctColor(s.pct_kehadiran) })}" data-v-e4c756a6${_scopeId}></div></div><div class="${ssrRenderClass(["text-xs font-bold font-mono text-right", pctTextClass(s.pct_kehadiran)])}" data-v-e4c756a6${_scopeId}>${ssrInterpolate(s.pct_kehadiran !== null ? s.pct_kehadiran + "%" : "—")}</div></div></div>`);
                });
                _push2(`<!--]-->`);
                if (!topSiswa.value.length) {
                  _push2(`<div class="px-5 py-10 text-center text-slate-400 text-sm" data-v-e4c756a6${_scopeId}> Belum ada data siswa. </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div><div class="bg-white dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden" data-v-e4c756a6${_scopeId}><div class="flex items-center justify-between px-5 py-3 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/30 flex-wrap gap-2" data-v-e4c756a6${_scopeId}><div class="flex items-center gap-2" data-v-e4c756a6${_scopeId}><span class="text-base" data-v-e4c756a6${_scopeId}>⚠️</span><span class="text-[11px] font-bold uppercase tracking-widest text-slate-600 dark:text-slate-400" data-v-e4c756a6${_scopeId}>Perlu Perhatian</span></div><div class="flex gap-1" data-v-e4c756a6${_scopeId}><!--[-->`);
                ssrRenderList(thresholdOptions, (opt) => {
                  ...
                  ])}" data-v-e4c756a6${_scopeId}>${ssrInterpolate(opt.label)}</button>`);
                });
                _push2(`<!--]--></div></div><div data-v-e4c756a6${_scopeId}><!--[-->`);
                ssrRenderList(bottomSiswa.value, (s, idx) => {
                  _push2(`<div class="flex items-center gap-3 px-5 py-3 border-b border-slate-100 dark:border-slate-700/50 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors" data-v-e4c756a6${_scopeId}><span class="text-xs text-slate-400 dark:text-slate-500 font-mono w-4 text-right flex-shrink-0" data-v-e4c756a6${_scopeId}>${ssrInterpolate(idx + 1)}</span><div class="w-8 h-8 rounded-full bg-rose-100 dark:bg-rose-900/40 text-rose-600 dark:text-rose-400 flex items-center justify-center text-xs font-bold flex-shrink-0" data-v-e4c756a6${_scopeId}>${ssrInterpolate(initials(s.nama_lengkap))}</div><div class="flex-1 min-w-0" data-v-e4c756a6${_scopeId}><div class="text-sm font-semibold text-slate-800 dark:text-white truncate" data-v-e4c756a6${_scopeId}>${ssrInterpolate(s.nama_lengkap)}</div><div class="text-xs text-slate-400 dark:text-slate-500 font-mono" data-v-e4c756a6${_scopeId}>${ssrInterpolate(s.nis)} · alpha ${ssrInterpolate(s.counts?.alpha ?? 0)}× </div></div><div class="w-20 flex-shrink-0" data-v-e4c756a6${_scopeId}><div class="h-1.5 rounded-full bg-slate-100 dark:bg-slate-700 overflow-hidden mb-1" data-v-e4c756a6${_scopeId}><div class="h-full rounded-full transition-all" style="${ssrRenderStyle({ width: (s.pct_kehadiran ?? 0) + "%", background: pctColor(s.pct_kehadiran) })}" data-v-e4c756a6${_scopeId}></div></div><div class="${ssrRenderClass(["text-xs font-bold font-mono text-right", pctTextClass(s.pct_kehadiran)])}" data-v-e4c756a6${_scopeId}>${ssrInterpolate(s.pct_kehadiran !== null ? s.pct_kehadiran + "%" : "—")}</div></div></div>`);
                });
                _push2(`<!--]-->`);
                if (!bottomSiswa.value.length) {
                  _push2(`<div class="px-5 py-10 text-center text-slate-400 dark:text-slate-500 text-sm" data-v-e4c756a6${_scopeId}><div class="text-3xl mb-2" data-v-e4c756a6${_scopeId}>✅</div> Semua siswa di atas ${ssrInterpolate(threshold.value)}% — bagus! </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div></div><div class="grid grid-cols-1 sm:grid-cols-5 gap-4" data-v-e4c756a6${_scopeId}><div class="sm:col-span-2 bg-white dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl p-5" data-v-e4c756a6${_scopeId}><p class="text-[11px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500 mb-3" data-v-e4c756a6${_scopeId}> Distribusi Status</p><div class="flex flex-wrap gap-3 mb-3" data-v-e4c756a6${_scopeId}><!--[-->`);
                ssrRenderList({ Hadir: "#639922", Sakit: "#BA7517", Izin: "#378ADD", Alpha: "#E24B4A" }, (color, key) => {
                  _push2(`<span class="inline-flex items-center gap-1.5 text-xs text-slate-600 dark:text-slate-300" data-v-e4c756a6${_scopeId}><span class="w-2.5 h-2.5 rounded-sm flex-shrink-0" style="${ssrRenderStyle({ background: color })}" data-v-e4c756a6${_scopeId}></span> ${ssrInterpolate(key)}</span>`);
                });
                _push2(`<!--]--></div><div style="${ssrRenderStyle({ "position": "relative", "height": "200px" })}" data-v-e4c756a6${_scopeId}><canvas id="analyticsDonut" role="img" aria-label="Pie chart distribusi status kehadiran kelas." data-v-e4c756a6${_scopeId}> Distribusi kehadiran kelas. </canvas></div></div><div class="sm:col-span-3 bg-white dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl p-5" data-v-e4c756a6${_scopeId}><div class="flex items-center justify-between mb-3" data-v-e4c756a6${_scopeId}><p class="text-[11px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500" data-v-e4c756a6${_scopeId}> Kehadiran Per Hari</p><div class="flex flex-wrap gap-2" data-v-e4c756a6${_scopeId}><!--[-->`);
                ssrRenderList({ Hadir: "#639922", Sakit: "#BA7517", Izin: "#378ADD", Alpha: "#E24B4A" }, (color, label) => {
                  _push2(`<span class="inline-flex items-center gap-1 text-[10px] text-slate-500 dark:text-slate-400" data-v-e4c756a6${_scopeId}><span class="w-2 h-2 rounded-sm" style="${ssrRenderStyle({ background: color })}" data-v-e4c756a6${_scopeId}></span>${ssrInterpolate(label)}</span>`);
                });
                _push2(`<!--]--></div></div><div style="${ssrRenderStyle({ "position": "relative", "height": "220px" })}" data-v-e4c756a6${_scopeId}><canvas id="analyticsBarDaily" role="img" aria-label="Bar chart kehadiran per hari." data-v-e4c756a6${_scopeId}> Kehadiran harian kelas. </canvas></div></div></div><div class="bg-white dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl p-5" data-v-e4c756a6${_scopeId}><div class="flex items-center justify-between mb-4 flex-wrap gap-2" data-v-e4c756a6${_scopeId}><p class="text-[11px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500" data-v-e4c756a6${_scopeId}> Tren Rata-rata Kehadiran Kelas </p><div class="flex gap-1 bg-slate-100 dark:bg-slate-900/50 rounded-lg p-0.5" data-v-e4c756a6${_scopeId}><button class="${ssrRenderClass(["px-3 py-1 rounded-md text-xs font-semibold transition-all", trendTab.value === "mingguan" ? "bg-blue-600 text-white" : "text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white"])}" data-v-e4c756a6${_scopeId}>Mingguan</button><button class="${ssrRenderClass(["px-3 py-1 rounded-md text-xs font-semibold transition-all", trendTab.value === "bulanan" ? "bg-blue-600 text-white" : "text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white"])}" data-v-e4c756a6${_scopeId}>Bulanan</button></div></div>`);
                if (trendData.value.length) {
                  _push2(`<div style="${ssrRenderStyle({ "position": "relative", "height": "200px" })}" data-v-e4c756a6${_scopeId}><canvas id="analyticsTrendLine" role="img" aria-label="Line chart tren rata-rata kehadiran kelas." data-v-e4c756a6${_scopeId}> Tren kehadiran kelas dari waktu ke waktu. </canvas></div>`);
                } else {
                  _push2(`<div class="py-10 text-center text-slate-400 dark:text-slate-500 text-sm" data-v-e4c756a6${_scopeId}> Data tren tidak tersedia untuk periode ini. </div>`);
                }
                _push2(`</div><!--]-->`);
              } else {
                _push2(`<!---->`);
                ...
                createVNode("header", null, [
                  createVNode("div", { class: "mx-auto py-4 px-2 flex items-center justify-between gap-4" }, [
                    createVNode("div", { class: "flex items-center gap-3" }, [
                      createVNode("div", { class: "w-9 h-9 rounded-xl bg-blue-500/20 text-blue-400 flex items-center justify-center text-lg flex-shrink-0" }, " 📊 "),
                      createVNode("div", null, [
                        createVNode("div", { class: "text-sm font-bold dark:text-gray-200 text-gray-700 leading-tight" }, "Attendance Analytics"),
                        createVNode("div", { class: "text-xs text-slate-400 mt-0.5" }, toDisplayString(__props.guru.nama_lengkap), 1)
                      ])
                    ])
                  ])
                ]),
                createVNode("main", { class: "mx-auto space-y-5 pb-10" }, [
                  !__props.kelas ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                    createVNode("div", { class: "text-center py-4" }, [
                      createVNode("span", { class: "inline-block px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-300 text-[11px] font-bold uppercase tracking-widest mb-3" }, " Langkah 1 "),
                      createVNode("h2", { class: "text-2xl font-extrabold text-slate-800 dark:text-white" }, "Pilih kelas untuk dianalisis "),
                      createVNode("p", { class: "mt-1.5 text-sm text-slate-500 dark:text-slate-400" }, "Lihat insight kehadiran, tren, dan siswa yang perlu perhatian.")
                    ]),
                    createVNode("div", { class: "max-w-md mx-auto mb-10" }, [
                    ...
                    hasData.value ? (openBlock(), createBlock(Fragment, { key: 2 }, [
                      ...
                      bottomSiswa.value.length ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("p", { class: "text-sm text-rose-700 dark:text-rose-300" }, [
                          ...
                          createTextVNode(" memiliki tingkat kehadiran di bawah " + toDisplayString(threshold.value) + "%. Segera tindaklanjuti! ", 1)
                        ])
                      ])) : createCommentVNode("", true),
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList(topSiswa.value, (s, idx) => {
                              return openBlock(), createBlock("div", {
                                ...
                                createVNode("div", { class: "flex-1 min-w-0" }, [
                                  ...
                                  createVNode("div", { class: "text-xs text-slate-400 dark:text-slate-500 font-mono" }, toDisplayString(s.nis), 1)
                                ]),
                          ...
                          createVNode("div", null, [
                            (openBlock(true), createBlock(Fragment, null, renderList(bottomSiswa.value, (s, idx) => {
                              return openBlock(), createBlock("div", {
                                ...
                                createVNode("div", { class: "flex-1 min-w-0" }, [
                                  createVNode("div", { class: "text-sm font-semibold text-slate-800 dark:text-white truncate" }, toDisplayString(s.nama_lengkap), 1),
                                  createVNode("div", { class: "text-xs text-slate-400 dark:text-slate-500 font-mono" }, toDisplayString(s.nis) + " · alpha " + toDisplayString(s.counts?.alpha ?? 0) + "× ", 1)
                                ]),
                                createVNode("div", { class: "w-20 flex-shrink-0" }, [
                                  createVNode("div", { class: "h-1.5 rounded-full bg-slate-100 dark:bg-slate-700 overflow-hidden mb-1" }, [
                                    createVNode("div", {
                        ...
                        createVNode("div", { class: "sm:col-span-3 bg-white dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-2xl p-5" }, [
                          createVNode("div", { class: "flex items-center justify-between mb-3" }, [
                            ...
                            createVNode("div", { class: "flex flex-wrap gap-2" }, [
                              (openBlock(), createBlock(Fragment, null, renderList({ Hadir: "#639922", Sakit: "#BA7517", Izin: "#378ADD", Alpha: "#E24B4A" }, (color, label) => {
                                return createVNode("span", {
                                  key: label,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Guru/AbsensiAnalytics.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const AbsensiAnalytics = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e4c756a6"]]);
export {
