import { computed, ref, onMounted, watch, unref, withCtx, openBlock, createBlock, createVNode, createTextVNode, createCommentVNode, withDirectives, vModelText, vModelSelect, toDisplayString, Fragment, renderList, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function confirmDeleteItem(id, event) {
      ...
      confirm({ text: "Yakin hapus quiz ini?" }).then((result) => {
        if (result.isConfirmed) {
          axios.delete(`/proktor/soal/${id}`).then((res) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Daftar Quiz" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mx-auto w-full sm:px-4 pb-16"${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:mb-8 mb-4 pt-2"${_scopeId}><div${_scopeId}><h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight leading-tight"${_scopeId}> Daftar Quiz &amp; Soal </h1></div>`);
            if (hasData.value) {
              _push2(ssrRenderComponent(unref(Link), {
                href: "/proktor/soal/create",
            ...
            if (isLoading.value) {
              ...
              ssrRenderList(paginatedSoal.value, (item) => {
                ...
                _push2(ssrRenderComponent(unref(Link), {
                  href: `/proktor/soal/${item.id}/edit`,
                  onClick: () => {
                  },
            ...
            if (!isLoading.value && hasFilteredData.value && totalPages.value > 1) {
              _push2(`<div class="text-center mt-3 text-xs text-gray-400 dark:text-gray-500"${_scopeId}> Halaman ${ssrInterpolate(currentPage.value)} dari ${ssrInterpolate(totalPages.value)} (${ssrInterpolate(filteredSoal.value.length)} item) </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
              ...
              createVNode("div", { class: "mx-auto w-full sm:px-4 pb-16" }, [
                createVNode("div", { class: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:mb-8 mb-4 pt-2" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight leading-tight" }, " Daftar Quiz & Soal ")
                  ]),
                      ...
                      createVNode("div", { class: "flex flex-col flex-1 p-5 gap-4" }, [
                        createVNode("div", { class: "flex items-start justify-between gap-3" }, [
                          createVNode("div", { class: "min-w-0" }, [
                            createVNode("p", { class: "font-bold text-base text-gray-900 dark:text-white leading-snug truncate w-full" }, toDisplayString(item.mapel?.mapel ?? "—"), 1),
                        ...
                        createVNode("div", { class: "grid grid-cols-3 gap-2" }, [
                          ...
                          createVNode("div", { class: "bg-slate-50 dark:bg-slate-700/50 rounded-xl px-3 py-2.5 text-center" }, [
                            createVNode("p", { class: "text-[9px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-1" }, " Poin "),
                            createVNode("p", { class: "text-xs font-bold text-gray-700 dark:text-gray-200" }, toDisplayString(avgNilai(item.bank_soal)), 1)
                          ])
                        ]),
                        createVNode("div", { class: "flex sm:flex-row flex-col gap-2 items-center justify-between text-[11px] text-gray-400 dark:text-gray-500" }, [
                          createVNode("div", { class: "flex items-center gap-3" }, [
                            createVNode("span", { class: "flex items-center gap-1" }, [
                              ...
                              createTextVNode(" " + toDisplayString(item.waktu) + " Menit ", 1)
                            ]),
                            createVNode("span", { class: "w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-600" }),
                            createVNode("span", null, toDisplayString(item.tipe_soal), 1),
                            createVNode("span", { class: "w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-600" }),
                            createVNode("span", {
                ...
                }, " Halaman " + toDisplayString(currentPage.value) + " dari " + toDisplayString(totalPages.value) + " (" + toDisplayString(filteredSoal.value.length) + " item) ", 1)) : createCommentVNode("", true)
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Proktor/Soal/Index.vue");
